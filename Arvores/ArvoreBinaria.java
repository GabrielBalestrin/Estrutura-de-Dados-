...
public class ArvoreBinaria {
	...
	public void inserirNaoRecursivo(int chave) {
	    if (buscarNodo(raiz, chave) != null) {
	        System.out.println("Número já existe na árvore: " + chave);
	        return;
	    }
	...
	public boolean buscar(int chave) {
	    boolean encontrado = buscarNodo(raiz, chave) != null;
	    if (encontrado) {
	        System.out.println("Valor " + chave + " encontrado na árvore.");
	    } else {
	        System.out.println("Valor " + chave + " não encontrado na árvore.");
	    }
	    return encontrado;
	}

	
	public void inserirIterativo(int chave) {
	    Nodo novoNodo = new Nodo(chave);
	...
	public void removerIterativo(int chave) {
	    Nodo current = raiz;
	    Nodo parent = null;
	    ...
	    else if (current.dir != null && current.esq != null) {
	        Nodo sucessor = encontraSucessor(current.dir);

	        current.chave = sucessor.chave;
	      
	        remover(sucessor.chave);
	    }


	    else {
	        Nodo child = (current.esq != null) ? current.esq : current.dir;
	        if (parent == null) {
	            raiz = child; 
	        } else if (isLeftChild) {
	            parent.esq = child;
	...
	public Nodo buscarIterativo(int chave) {
	    Nodo atual = raiz;
