	...
	public class avlTreeMain {
		public static void main(String[] args) {
			...
			System.out.println(
					"Tempo decorrido (Inserção - 100K - Ordenado): " + tempoInsercao100KOrdenado + " milissegundos");
			System.out
					.println("Tempo decorrido (Remoção - 100K - Ordenado): " + tempoRemocao100KOrdenado + " milissegundos");
			...
			if (encontrado) {
				System.out.println("Valor " + valorBuscado + " encontrado na árvore AVL.");
			} else {
				System.out.println("Valor " + valorBuscado + " não encontrado na árvore AVL.");
			}
